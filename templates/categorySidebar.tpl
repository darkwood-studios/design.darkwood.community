...
{if !$labelGroups|empty}
    <section class="box">
        <form id="communityLabelForm" method="post" action="{link application='community' controller='category' id=$category->categoryID}{/link}">
            ...
            <div class="boxContent">
                ...
                <div class="formSubmit">
                    ...
                    {* {if $id|isset}<input type="hidden" name="id" value="{$id}">{/if} *}
                </div>
            </div>
        </form>
    </section>
