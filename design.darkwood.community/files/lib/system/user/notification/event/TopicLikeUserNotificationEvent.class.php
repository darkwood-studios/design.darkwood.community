...
/**
 * Class TopicLikeUserNotificationEvent
 *
 ...
 */
class TopicLikeUserNotificationEvent extends AbstractSharedUserNotificationEvent
{
    ...
    public function getTitle()
    {
        ...
        if ($count > 1) {
            return $this->getLanguage()->getDynamicVariable('community.topic.like.notification.title.stacked', [
                'count' => $count,
                'timesTriggered' => $this->notification->timesTriggered
            ]);
        }

        return $this->getLanguage()->get('community.topic.like.notification.title');
    }
    ...
    public function getMessage()
    {
        ...
        if ($count > 1) {
            return $this->getLanguage()->getDynamicVariable('community.topic.like.notification.message.stacked', [
                'author' => $this->author,
                'authors' => $authors,
                'count' => $count,
                'others' => $count - 1,
        ...
        return $this->getLanguage()->getDynamicVariable('community.topic.like.notification.message', [
            'author' => $this->author,
            'topic' => $topic,
            'reactions' => $this->getReactionsForAuthors()
        ]);
